...
describe('domainStory modeler', function() {
  ...
  '{"type":"domainStory:activity","name":"to","id":"connection_8339","number":null,"waypoints":[{"original":{"x":560,"y":513},"x":522,"y":513},{"x":256,"y":513},{"original":{"x":256,"y":218},"x":256,"y":249}],"source":"shape_7902","target":"shape_9977"},'+
  '{"info":"Assumption: no line at box office, seats available, cash payment"},{"version":"0.4.0-dev"}]';
  ...
  describe('domainStory import Test old intricate data V_0_3_0', function() {
    ...
    // spin up modeler with custom element, do this only once, using before each takes too long and triggers the timeout
    modeler = new DomainStoryModeler({ container: container });
    oldIntricateV_0_2_0_Data = updateCustomElementsPreviousv050(oldIntricateV_0_3_0_Data);
    modeler.importCustomElements(oldIntricateV_0_2_0_Data, function(err) {
      if (err) {
        console.log(err);
      }
  ...
  describe('domainStory import export Test intricate data', function() {
    ...
    // given
      ...
      expect(oldIntricateV_0_3_0_JsonString.length).to.eql(jsonLength);

      jsonElements.forEach(element =>{
        expect(oldIntricateV_0_3_0_JsonString.includes(element)).to.be.true;
      });
    });
  });
});