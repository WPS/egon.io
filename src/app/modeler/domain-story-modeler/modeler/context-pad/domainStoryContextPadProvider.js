...
import { getAllStandardIconKeys } from "src/app/domain-configuration/domain/allIcons";
...
export default function DomainStoryContextPadProvider(
  ...
  function addWorkObjects(appendAction, actions) {
    ...
    workObjectTypes.keysArray().forEach((workObjectType) => {
      ...
      let icon = iconDictionaryService.getIconForType(workObjectType);
      let action = [];
  ...
  function addActors(appendAction, actions) {
    ...
    actorTypes.keysArray().forEach((actorType) => {
      ...
      let icon = iconDictionaryService.getIconForType(actorType);
      let action = [];
