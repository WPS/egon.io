import { testActivityCanvasObject } from '../common/domain/activityCanvasObject';
import { deepCopy } from '../common/util/deepCopy';
import {
  angleBetween,
  degrees,
  positionsMatch,
} from '../common/util/mathExtensions';
import { elementTypes } from '../common/domain/elementTypes';
import { getNameFromType } from '../common/util/naming';
import { sanitizeForDesktop, sanitizeIconName } from '../common/util/sanitizer';
