...
EgonLayouter.prototype.layoutConnection = function (connection, hints) {
  ...
  if (hints.connectionStart) {
    sourceShape.x = connectionStart.x;
    sourceShape.y = connectionStart.y;
    connection.waypoints[0] = getMid(sourceShape);
  }

  const targetShape = connection.target;
  if (hints.connectionEnd) {
    targetShape.x = connectionEnd.x;
    targetShape.y = connectionEnd.y;
